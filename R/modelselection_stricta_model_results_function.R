modelselection_stricta_model_results_function <- function(models.dimensions, convergence.status, parameter.estimates, conditional.fit.statistics, replace_list, select_list) {
	# model dimensions
	x = models.dimensions %>% 
